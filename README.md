...
A token is a string recieved from a server once the user has met the authetication criteria. That token grants the user permission to view certain components or perform certain tasks.

- [ ] What steps can you take in your web apps to keep your data secure?

Requiring authentication to view sensitive material, testing to ensure a secure front end, and having encrypted forms for passwords.

- [ ] Describe how web servers work.

Servers store all of the data that will be displayed and used in a web app/page. Computers request information from these servers and the servers send a response.
